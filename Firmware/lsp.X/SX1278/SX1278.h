...
/********************LoRa mode***************************/
#define LR_RegFifo                                  0x00  // FIFO read/write access
// Common settings
#define LR_RegOpMode                                0x01  // Operating mode
#define LR_RegFrMsb                                 0x06  // RF Carrier Frequency
#define LR_RegFrMid                                 0x07  // RF Carrier Frequency
#define LR_RegFrLsb                                 0x08  // RF Carrier Frequency
// Tx settings
#define LR_RegPaConfig                              0x09  // PA selection and Output Power control
#define LR_RegPaRamp                                0x0A  // Control of PA ramp time, low phase noise PLL
#define LR_RegOcp                                   0x0B  // Over Current Protection control
// Rx settings
#define LR_RegLna                                   0x0C  // LNA settings
// LoRa registers
#define LR_RegFifoAddrPtr                           0x0D  // SPI interface address pointer in FIFO data buffer
#define LR_RegFifoTxBaseAddr                        0x0E  // write base address in FIFO data buffer for TX modulator
#define LR_RegFifoRxBaseAddr                        0x0F  // read base address in FIFO data buffer for RX demodulator
#define LR_RegFifoRxCurrentaddr                     0x10  // Start address (in data buffer) of last packet received
#define LR_RegIrqFlagsMask                          0x11  // Optional IRQ flag mask
#define LR_RegIrqFlags                              0x12  // IRQ flags
#define LR_RegRxNbBytes                             0x13  // Number of payload bytes of latest packet received
#define LR_RegRxHeaderCntValueMsb                   0x14  // Number of valid headers received
#define LR_RegRxHeaderCntValueLsb                   0x15  // Number of valid headers received
#define LR_RegRxPacketCntValueMsb                   0x16  // Number of valid packets received
#define LR_RegRxPacketCntValueLsb                   0x17  // Number of valid packets received
#define LR_RegModemStat                             0x18  // Live LoRaTM modem status
#define LR_RegPktSnrValue                           0x19  // Espimation of last packet SNR
#define LR_RegPktRssiValue                          0x1A  // RSSI of last packet
#define LR_RegRssiValue                             0x1B  // Current RSSI
#define LR_RegHopChannel                            0x1C  // FHSS start channel
#define LR_RegModemConfig1                          0x1D  // Modem PHY config 1
#define LR_RegModemConfig2                          0x1E  // Modem PHY config 2
#define LR_RegSymbTimeoutLsb                        0x1F  // Receiver timeout value
#define LR_RegPreambleMsb                           0x20  // Size of preamble
#define LR_RegPreambleLsb                           0x21  // Size of preamble
#define LR_RegPayloadLength                         0x22  // LoRaTM payload length
#define LR_RegMaxPayloadLength                      0x23  // LoRaTM maximum payload length
#define LR_RegHopPeriod                             0x24  // FHSS Hop period
#define LR_RegFifoRxByteAddr                        0x25  // Current value of RX databuffer pointer
#define LR_RegModemConfig3                          0x26  // Modem PHY config 3
// I/O settings
...
// Version
#define REG_LR_VERSION                              0x42  // Version code of the chip
// Additional settings
#define REG_LR_TCXO                                 0x4B  // TCXO or XTAL input setting
#define REG_LR_PADAC                                0x4D  // Higher power settings of the PA
#define REG_LR_FORMERTEMP                           0x5B  // Stored temperature during the former IQ Calibration
#define REG_LR_AGCREF                               0x61  // Adjustment of the AGC thresholds
#define REG_LR_AGCTHRESH1                           0x62  // Adjustment of the AGC thresholds
#define REG_LR_AGCTHRESH2                           0x63  // Adjustment of the AGC thresholds
#define REG_LR_AGCTHRESH3                           0x64  // Adjustment of the AGC thresholds
...
/**
 * \brief Enter Channel Activity Detection mode
 *
 * Enter Channel Activity Detection mode.
 *
 * \param[in]  module   Pointer to LoRa structure
 */
void SX1278_CAD(SX1278_t *module);
